  ...
  return (
    <section id="gudang" className="section-anchor space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-tertiary">GUDANG STOK</p>
         
          <h2 className="mt-1 text-3xl font-semibold text-primaryDark">data barang</h2>
          <p className="text-base text-secondary">Pencatatan stok masuk dan keluar </p>
        </div>
        <button
